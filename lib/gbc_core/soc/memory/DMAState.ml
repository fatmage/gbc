...
module VRAM = struct
  ...
  type t = { hdma1 : int; hdma2 : int; hdma3 : int; hdma4 : int; hdma5 : int; in_progress : bool}
  let initial = { hdma1 = 0xFF; hdma2 = 0xFF; hdma3 = 0xFF; hdma4 = 0xFF; hdma5 = 0xFF; in_progress = false }
  let get m =
    function
    | 0xFF51 -> m.hdma1
    | 0xFF52 -> m.hdma2
  ...
  let set m i v =
    ...
    | 0xFF55 ->
      begin match m.in_progress with
      | false ->
        { m with hdma5 = v; in_progress = true; }
      | true ->
